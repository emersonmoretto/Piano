 ...
 * Baseado na trasnformação proposta por Alain Lebret (University Pierre and Marie Curie - France).
 * V. 1.2
 *  
 *  Faz a transformação do espaço RGB para YCbCr 
 *
 ...
 *  
 * - TODO: 
 * Tentar aprimorar a escolha de candidado à pele, está errando um pouco ainda com tons de vermelho. 
 * Acredito ser também por causa da qualidade da minha webcam 
 * 
...
public class SkinExtractor {
	 ...
	 * Método Extract
	 * 
	 * recebe uma imagem (BufferedImage) e o que é pele vira pixel_ob, o que não é vira pixel_bg
	 */
	public int[] extract(BufferedImage imgBuff) {
		...
		//Se é pele vira pixel_ob caso contrário pixel_bg
